...
/**
 * Export filenames share one shape: gourl-<kind>-<local timestamp>.<ext>
 * (e.g. gourl-links-2026-08-19-10-30-00.csv). The timestamp is local time so
